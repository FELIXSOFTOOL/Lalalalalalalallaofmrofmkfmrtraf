...
START_VIDEO_PATH = "start_video.mp4"
START_VIDEO_URL = ""
...
def start_media():
    ...
    video_path = os.path.join(BASE_DIR, START_VIDEO_PATH) if START_VIDEO_PATH else ""
    avatar_path = os.path.join(BASE_DIR, AVATAR_PATH) if AVATAR_PATH else ""
